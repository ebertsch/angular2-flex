...
# This script should be run from the root of the angular2-flex repo.
...
if [ "${NPM_USER}" != "angular2-flex" ]; then
  echo "You must be logged in as 'angular2-flex' to publish. Use 'npm login'."
  exit
fi
